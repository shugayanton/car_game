...
public class Praktikum {
    ...
    private static void changePointAndDistance(Car userCar, int racePoints, int raceDistance) { // реализуйте метод
        ...
        userCar.score += racePoints;
        userCar.kilometersTravelled += raceDistance;
    }
